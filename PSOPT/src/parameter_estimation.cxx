...
EndpointCostForParameterEsimator endpoint_cost_for_parameter_estimation;
adouble EndpointCostForParameterEsimator::operator ()(adouble* initial_states, adouble* final_states, adouble* parameters,adouble& t0, adouble& tf, adouble* xad, int iphase, Workspace* workspace)
{
